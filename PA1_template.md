...
plot(rownames(intrvlSteps), intrvlSteps, type = "l", col = "darkolivegreen3", 
    main = "Average dailyl activity pattern", xlab = "Interval", ylab = "Number of Steps")
```
...
The interval that, on average across all days in the dataset, contains the maximum number of steps is <b>interval 835</b>.
...
The new dataset containing imputed values is <i><b>impActivity</b></i>.
